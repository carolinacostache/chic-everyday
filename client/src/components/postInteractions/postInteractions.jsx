    ...
    <>
      <div className="postInteractions">
        <div className="interactionIcons">
          <button
            type="button"
            className={`iconButton likeButton ${data.isLiked ? "isActive" : ""}`}
          ...
          >
            ...
            >
              <path
                ...
                stroke={data.isLiked ? "#274b7a" : "#2f1b22"}
                strokeWidth="2"
                fill={data.isLiked ? "#274b7a" : "none"}
              />
            </svg>
          </button>

          <span className={`likeCount ${data.isLiked ? "isActive" : ""}`}>
            {data.likeCount}
          </span>

          <button type="button" className="iconButton shareButton">
            <NImage src="/general/share.svg" alt="Distribuie" />
          </button>

          <div className="moreOptionsButton" ref={menuRef}>
            <button
              type="button"
              className="iconButton moreOptionsTrigger"
        ...
        <button
          type="button"
          className={`savePrimary ${data.isSaved ? "isSaved" : ""}`}
      ...
      {isSaveModalOpen && (
        <Save pinId={postId} onClose={() => setIsSaveModalOpen(false)} />
      )}
    </>
  );
};
